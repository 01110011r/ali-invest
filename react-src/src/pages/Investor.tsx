    ...
    return (
            <div>
                        ...
                        <div className={'p-6 flex flex-col border-2 rounded-3xl'}>
                            ...
                            <div className={'flex flex-col gap-6'}>
                                <p className={'text-[#F97B07] font-semibold text-2xl'}>Обязательно: <span
                                    className={'text-[#7E8492] font-semibold'}>наличие как минимум первой выручки</span>
                                </p>
                ...
                <div className={'mb-10 text-center'}>
                    ...
                    <div
                        className={'border-t-2 border-b-2 py-10 flex flex-col lg:flex-row items-center justify-between'}>
                ...
                <div className={'mb-24'}>
                    ...
                    <div className={'grid lg:grid-cols-6 grid-rows-2 md:grid-cols-2 grid-cols-1 gap-6'}>
                        <div className={'border-2 rounded-2xl col-span-2 py-10 px-4'}>
                            ...
                            <p className={'text-[#7E8492]'}>
                                AliInvest помогли нам привлечь первый раунд инвестиций на $400k. Ребята взяли на себя
                                работу
                                по первичной коммуникации с инвесторами, а нас звали на встречи только с
                                заинтересованными.
                ...
                <div className={'flex bg-[#FFF9F4] rounded-3xl p-12 mb-32 relative'}>
                    <div className={'lg:max-w-[50%] flex flex-col gap-8 items-start'}>
                        ...
                        <p className={'text-[#7E8492]'}>
                            Если вы вовлечены в венчурный рынок (но не стартап или инвестор), напишите нам. Мы будем
                            рады найти точки общего взаимодействия.
                        </p>
